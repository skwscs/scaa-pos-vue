              ...
              <v-layout class="pa-0 ma-0">
                <v-flex xs4 class="pa-0 ma-0 pa-3">
                  ...
                  <v-btn
                    ...
                    block
                    class="mt-3"
                    :color="colorButtonPayment(1)"
                    @click="clickPayByCash"
                  >
                  ...
                  <v-btn
                    ...
                    large
                    class="mt-3"
                    :color="colorButtonPayment(2)"
                    @click="clickPayByCredit"
                  >
                    ...
                    <v-flex xs3 class="pa-0 pt-2 pb-4 ma-0 grey darken-1">
                      ...
                      >
                        ...
                        <h1
                          ...
                          :style="
                            `font-size: 36px; color: ${changeAmount >= 0 ? '#00E676' : '#FF3D00'};`
                          "
                        >
                    ...
                    >
                      ...
                      <v-layout column class="pa-0 ma-0">
                        <v-flex xs3 class="pa-0 ma-0 indigo lighten-1">
                          ...
                          >
                            <v-icon size="small" color="white" class="mr-2">fas fa-user</v-icon
                            >Customers
                          </v-btn>
                        </v-flex>
                        <v-flex xs3 class="pa-0 ma-0 indigo darken-1">
                          ...
                          <v-btn
                            ...
                            :loading="isLoading"
                          >
                            <v-icon size="small" color="white" class="mr-2">fas fa-check</v-icon
                            >Validate
                          </v-btn>
                        </v-flex>
